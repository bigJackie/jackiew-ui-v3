            ...
            >
              ...
              >
                <j-list-item
                  ...
                  no-icon
                >
                  <j-list-item-content class="pl-4">{{
                    subitem.text
                  }}</j-list-item-content>
                </j-list-item>
                <j-list-item-content v-if="!item.items">{{
                  item.text
                }}</j-list-item-content>
              </component>
            </j-list-group>
        ...
        <j-main>
          <j-doc>
            <j-row>
              <j-col
                cols="24"
                :lg="page.headers.length > 0 ? 18 : 0"
                :xl="page.headers.length > 0 ? 19 : 0"
              >
                <Content />
              </j-col>
              <j-col
                cols="0"
                :lg="page.headers.length > 0 ? 6 : 0"
                :xl="page.headers.length > 0 ? 5 : 0"
              >
