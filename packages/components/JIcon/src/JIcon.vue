  ...
  <component
    ...
    :style="{
      ...
      cursor: disabled
        ...
        ? 'pointer'
        : 'default',
      transform: `rotateZ(${parseFloat(rotate as string)}deg) scale(${
        flip == 'horizontal' || flip == 'both' ? -1 : 1
      }, ${flip == 'vertical' || flip == 'both' ? -1 : 1})`,
      '-moz-transform': `rotateZ(${parseFloat(rotate as string)}deg) scale(${
        flip == 'horizontal' || flip == 'both' ? -1 : 1
      }, ${flip == 'vertical' || flip == 'both' ? -1 : 1})`,
      '-webkit-transform': `rotateZ(${parseFloat(rotate as string)}deg) scale(${
        flip == 'horizontal' || flip == 'both' ? -1 : 1
      }, ${flip == 'vertical' || flip == 'both' ? -1 : 1})`,
      '-o-transform': `rotateZ(${parseFloat(rotate as string)}deg) scale(${
        flip == 'horizontal' || flip == 'both' ? -1 : 1
      }, ${flip == 'vertical' || flip == 'both' ? -1 : 1})`,
    }"
